...
class PurchaseRequest(models.Model):
    ...
    # Saisis ultérieurement par les achats
    ...
    refusal_reason = models.TextField(blank=True, null=True) # Nouveau champ

    def save(self, *args, **kwargs):
        if not self.order_number:
            # Générer automatiquement le numéro de commande CMD-YYYY-XXXX
            import datetime
